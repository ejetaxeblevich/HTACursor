...
1. Скачайте [архив](https://github.com/ejetaxeblevich/HTACursor/releases) и распакуйте курсоры `.cur` и `.ani` из папки `HTA cursors` в удобную для вас папку на компьютере;
...
1. Download the [archive](https://github.com/ejetaxeblevich/HTACursor/releases) and unpack the `.cur` and `.ani` cursors from the `HTA cursors` folder to a convenient folder on your computer;
